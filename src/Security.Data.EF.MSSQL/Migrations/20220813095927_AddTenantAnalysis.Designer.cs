...
namespace Security.Data.EF.Migrations
{
    ...
    [Migration("20220813095927_AddTenantAnalysis")]
    partial class AddTenantAnalysis
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Objects.Entities.Security.Session", b =>
                {
            ...
            modelBuilder.Entity("Core.Objects.Entities.Security.TenantAnalysis", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Objects.Entities.Security.UserEvent", b =>
                {
                    ...
                    b.HasOne("Core.Objects.Entities.Security.Session", "Session")
                        .WithMany("UserEvents")
