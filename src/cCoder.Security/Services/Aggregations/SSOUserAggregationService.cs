        ...
        : ISSOUserAggregationService
{
    ...
    public ValueTask<(SSOUser, string)> RegisterUserAsync(
        RegisterUser registerForm) =>
        TryCatch<(SSOUser, string)>(operation: async () =>
        {
    ...
    public ValueTask<SSOUser> UpdateSSOUserAsync(
        ...
        TryCatch<SSOUser>(operation: async () =>
        {
            ...
            return await UpdateSSOUserCoreAsync(
                username: username,
                updatedSSOUser: updatedSSOUser);
        });
    ...
    public ValueTask<(SSOUser, string)> InviteRegisterUserAsync(
        RegisterUser registerForm) =>
        TryCatch<(SSOUser, string)>(operation: async () =>
        {
    ...
    public ValueTask<SSOUser> AcceptRegisterUserInviteAsync(
        RegisterUser registerForm,
        string userId,
        string tokenId) =>
        TryCatch<SSOUser>(operation: async () =>
    ...
    private async ValueTask<(SSOUser, string)> RegisterUserCoreAsync(
        RegisterUser registerForm)
    {
    ...
    private async ValueTask<SSOUser> UpdateSSOUserCoreAsync(
        string username,
        SSOUser updatedSSOUser)
    {
    ...
    private async ValueTask<(SSOUser, string)> InviteRegisterUserCoreAsync(
        RegisterUser registerForm)
    {
    ...
    private async ValueTask<SSOUser> AcceptRegisterUserInviteCoreAsync(
        RegisterUser registerForm,
        string userId,
        string tokenId)
    {
